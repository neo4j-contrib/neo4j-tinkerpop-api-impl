...
public class Neo4jRelationshipImpl extends Neo4jEntityImpl<Relationship> implements Neo4jRelationship {
    ...
    public Neo4jNode start() { return new Neo4jNodeImpl(entity.getStartNode()); }
    public Neo4jNode end() { return new Neo4jNodeImpl(entity.getEndNode()); }
    public Neo4jNode other(Neo4jNode node) { return new Neo4jNodeImpl(entity.getOtherNode((((Neo4jNodeImpl)node).entity))); }
}
